...
public class BasicProcessor {
	...
	public void process() throws Exception {
		...
		// String result = this.getPageContent(stockRadar,false);
		// System.out.println(result);

		// result = http.GetPageContent(stockCASS,false);
		// System.out.println(result);

		// result = this.getPageContent(stockXMTrade,false);
		// System.out.println(result);
	}

	protected String getPageContent(String url, boolean initialFlag)
			throws Exception {
	...
	protected void sendPost(String url, String postParams) throws Exception {
		...
		conn.setRequestProperty("Referer",
				"http://www.stockradar.hk/page.php?p=login");
